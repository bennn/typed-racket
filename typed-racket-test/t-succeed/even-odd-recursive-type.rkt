...
(module num-even/odd typed/racket #:transient
...
(module poly-even/odd typed/racket #:transient
...
(module let-even/odd typed/racket #:transient
  (let ()
    (define-type (Even A) (U Null (Pairof A (Odd A))))
...
(module even/odd* typed/racket #:transient
