...
(module even-odd typed-scheme #:transient
...
(module date typed-scheme #:transient
...
(module tree typed-scheme #:transient
...
(module add-list typed-scheme #:transient
  (define: (sum-list [l : (Listof Number)]) : Number
    (cond [(null? l) 0]
          [else (+ (car l) (sum-list (cdr l)))])))

(module maybe typed-scheme #:transient
